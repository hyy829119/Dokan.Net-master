    ...
    info.Context, newName, replace);
        ...
        public NtStatus GetDiskFreeSpace(out long freeBytesAvailable, out long totalNumberOfBytes, out long totalNumberOfFreeBytes, IDokanFileInfo info)
        {
            ...
            if (lastActiveSubsytem != null)
            {
                ...
                if (ops != null)
                    return ops.GetDiskFreeSpace(out freeBytesAvailable, out totalNumberOfBytes, out totalNumberOfFreeBytes, info);
            }
            long terabyte = (long)1024 * 1024 * 1024 * 1024;
            totalNumberOfBytes = 10 * terabyte;//1TB for Explorer to see space
            totalNumberOfFreeBytes = terabyte;
